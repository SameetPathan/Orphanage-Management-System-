...
<nav class="navbar navbar-light bg-warning">
    ...
    <div> 
        <button class="btn btn-outline-dark my-2 my-sm-0" data-bs-toggle="modal" data-bs-target="#exampleModal3">Add Donation Manually</button>
    </div>
...
<div class="container mt-2">
    ...
    <tbody>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            ?>
            <td><form action="UpdateDonation.php" method="post">
            <input type="text" name="donation_id" hidden value="<?php echo $row['donation_id']??''; ?>">
